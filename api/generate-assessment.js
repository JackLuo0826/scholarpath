...
- DEVELOPING (NCEA Level 1 skills): Harmony in depth (modulation to closely related keys — dominant, subdominant, relative major/minor; secondary dominants; non-chord tones — passing note, suspension, appoggiatura; voice-leading principles); music history and context (Baroque characteristics — basso continuo, counterpoint, ornamentation; Classical — sonata form, balanced phrases, homophony; Romantic — programme music, extended harmony, nationalism; 20th century — impressionism, expressionism, minimalism, serialism; jazz and popular music — blues scale, improvisation, 12-bar form); composition skills (composing a piece in a specific style; using motif development, sequences, and variation; writing for specific ensembles; notation using software or manuscript); aural skills (identifying intervals by ear; recognising chord types; transcribing short melodic and rhythmic passages; identifying musical features in an unseen/unheard score)
- ADVANCED (NCEA Level 2 skills): Extended chromatic harmony; composing with complex formal structures; music analysis using music theory vocabulary and historical context; performance at a higher technical level`
    }
    if (nzcLevel.includes('Level 7') || nzcLevel.includes('NCEA Level 2') || nzcLevel.includes('Year 12')) {
