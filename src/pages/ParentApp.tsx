...
export default function ParentApp() {
  const { messages, logout: logoutFn, apiKey, setApiKey, model, setModel, goalPlan, setGoalPlan, universityPath, setUniversityPath, childInfo, updateChildProfile } = useApp()
